...
II. [Tại sao mô hình AI cần quantization?](#2-tại-sao-mô-hình-ai-cần-quantization)
III. [FP32 lưu một con số như thế nào?](#3-fp32-lưu-một-con-số-như-thế-nào)
IV. [Ý tưởng cốt lõi: đổi từ số thực sang các ô số nguyên](#4-ý-tưởng-cốt-lõi-đổi-từ-số-thực-sang-các-ô-số-nguyên)
V. [Scale và Zero-point thực sự có ý nghĩa gì?](#5-scale-và-zero-point-thực-sự-có-ý-nghĩa-gì)
VI. [Công thức quantization và dequantization](#6-công-thức-quantization-và-dequantization)
VII. [Ví dụ tính tay từ FP32 sang INT8](#7-ví-dụ-tính-tay-từ-fp32-sang-int8)
VIII. [Cài đặt symmetric INT8 bằng NumPy](#8-cài-đặt-symmetric-int8-bằng-numpy)
IX. [Weights-only quantization là gì?](#9-weights-only-quantization-là-gì)
X. [Vì sao outlier có thể phá hỏng quantization?](#10-vì-sao-outlier-có-thể-phá-hỏng-quantization)
XI. [Per-tensor, per-channel và group-wise](#11-per-tensor-per-channel-và-group-wise)
XII. [Quantization 4-bit hoạt động như thế nào?](#12-quantization-4-bit-hoạt-động-như-thế-nào)
XIII. [Đóng gói hai số 4-bit vào một byte](#13-đóng-gói-hai-số-4-bit-vào-một-byte)
XIV. [PTQ và QAT khác nhau ra sao?](#14-ptq-và-qat-khác-nhau-ra-sao)
XV. [Toàn bộ pipeline nhìn trong một sơ đồ](#15-toàn-bộ-pipeline-nhìn-trong-một-sơ-đồ)
XVI. [Những hiểu lầm thường gặp](#16-những-hiểu-lầm-thường-gặp)
XVII. [Bài thực hành nhỏ](#17-bài-thực-hành-nhỏ)
XVIII. [Tóm tắt kiến thức](#18-tóm-tắt-kiến-thức)
